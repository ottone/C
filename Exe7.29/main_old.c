...
void visualizza_sorgenti(int instruction[], int accumulator, int instructionCounter, int instructionRegister, int operationCode, int operand){
	...
	// per permettere di elaborare i valori in virgola mobile bisogna dapprima permettere di immagazzinare tale valore che dovrà essere memorizzato in 
	// due locazioni di memoria una per la parte intera e una per i decimali. La memoria è un array di interi
	// Per le operazioni bisogna invece prevedere una variabile in virgola mobile. La difficolta sta nel richiamare il valore
