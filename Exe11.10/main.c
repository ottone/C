...
//  
//  E' probabile (anzi molto comune) che ci siano diversi record di transazione con la stessa chiave. Ciò potrebbe accadere perchè, durante un periodo commerciale,
//  un particolare cliente potrebbe effettuare diversi acquisti e pagamenti. Riscrivete il vostro programma di file-matching per la contabilità del credito scritto
//  nell'Esercizio 11.7, in modo che sia possibile gestire svariati record di transazione con la stessa chiave. Modificate i dati di prova dell'Esercizio 11.8, in
//  modo da includere questi record di transazione:
//
